  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocListener(
        listeners: [
          ...
          BlocListener<StoryListBloc, StoryListState>(
        ...
        child: BlocBuilder<StoryListBloc, StoryListState>(
          ...
          return PageTemplate(
              ...
              floatingActionButton: (FlavorConfig.instance.flavor ==
                      FlavorType.dev)
                  ? const SizedBox()
                  : Container(
                      ...
                      child: FloatingActionButton(
                        backgroundColor: ColorWidget.primaryColor,
                        onPressed: () =>
                            context.pushRoute(const StoryFormRoute()),
                        isExtended: true,
                        elevation: 0.0,
                  ...
                  child: (state.listEntity?.listStory.isNotEmpty ?? false)
                      ? NotificationListener<ScrollNotification>(
                            ...
                            if (scrollNotification
                              ...
                              if (scrollNotification.metrics.pixels ==
                                ...
                                if (storyCount < size) {
                                  ...
                                  page++;
                                  sl<StoryListBloc>().add(ListMoreEvent(
                                      page: page, size: size, location: 0));
                                }
                              }
                            }
                            return false;
                          ...
                          child: SingleChildScrollView(
                              ...
                              child: ((state.listEntity?.listStory.isEmpty ??
                                          false) ||
                                      state.isLoading)
                                  ? const SizedBox(
                                      height: 24,
                                        ...
                                        ListView.builder(
                                            ...
                                            itemBuilder: (BuildContext context,
                                              ...
                                              return ItemStoryWidget(
                                                  ...
                                                  description: listStory[index]
                                                      .description,
                                                  imageUrl:
                                                      listStory[index].photoUrl,
                                                  createdAt: listStory[index]
                                                      .createdAt);
                                            }),
